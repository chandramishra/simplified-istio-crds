...
XPKGS = provider-istio
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-istio: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Istio CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Istio controllers
...
# This target prepares repo for your provider by replacing all "istio"
